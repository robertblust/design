...
test("names exactly the nine fences this release ships", () => {
  assert.deepEqual([...FENCE_NAMES].sort(),
    ["deck fit", "deck lockup", "deck transport", "design tokens", "header contract", "language",
     "prose footer", "prose reset", "stage contract"]);
});
